 ...
 *      <li>If the password is not set, the 7 digit password will be generated randomly and reset by SMS (or e-mail) authentication code.</li>
 *     </ul>
 * </p>
...
public class User {
    ...
    private User() {
        ...
        this.password = DomainRegistry.encryption().encrypt(ANONYMOUS_OF_ID);
     ...
     * @param telephoneNumber
     * @param enablement
     * @throws IllegalArgumentException if the length of the id is not [3,128) or is reservation
