...
public class PrivilegeRepositoryTest {
    ...
    public static void setUpBeforeClass() {
        ...
        Privilege privilege = new Privilege("open_box", "box", casher.toRoleDescriptor(), job, box.toResourceDescriptor());
        System.out.println(privilege);
        System.out.println(privilege.toConstantName());
        job = new Job("read", null);
        privilege = new Privilege("read_catalog", "catalog", casher.toRoleDescriptor(), job, fresh.toResourceDescriptor());
        System.out.println(privilege.toConstantName());
